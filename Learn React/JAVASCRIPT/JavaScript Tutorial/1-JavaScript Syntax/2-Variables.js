...
//Aynı ismi birden fazla kez kullanmanıza izin vermez. Bu, kodun daha temiz ve güvenli olmasını sağlar.
let y = 10;
if (true) {
    let y = 20;
...
const z = 15; 
// z = 20; // Hata verir çünkü `const` ile tanımlanan bir değeri değiştiremezsiniz.
